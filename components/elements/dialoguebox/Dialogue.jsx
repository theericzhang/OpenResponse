...
export default function Dialogue () {
    ...
    // display a return key suggestion if the user has stopped tying for 3 seconds.
    // useEffect captures the state of the input and debounces the timer when the user enters a key within 3 seconds of the last one
    // return statement destroys the setTimeout function
    // useEffect(() => {
    //     if (!!userInput) {
    //         setIsReturnVisible(false);
    //         const delayedReturnSuggestion = setTimeout(() => {
    //             console.log('hit return');
    //             setIsReturnVisible(true);
    //         }, 3000);

    //         return () => {clearTimeout(delayedReturnSuggestion)}
    //     } else {
    //         setIsReturnVisible(false);
    //     }
    // }, [userInput])
    // no longer needed as design requirements changed
    ...
    async function inputSubmissionHandler(e) {
        ...
        // this setResult should be the response state
