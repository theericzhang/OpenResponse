    ...
    return (
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <Logo />
                {!isPromptViewOpen && <div className={styles["left-column"]}>
                    <div className={styles["intro-text-description-wrapper"]}>
                    ...
                    <div className={styles["call-to-action-row"]}>
                        <p className={styles["description-call-to-action"]}>
                            Prompts can be extremely open-ended or as specific as you’d like.
                        </p>
                        {!isPromptViewOpen && <GetStartedButton setIsPromptViewOpen={setIsPromptViewOpen} />}
                    </div>
